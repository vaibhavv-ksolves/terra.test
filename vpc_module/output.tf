locals {
  redshift_route_table_ids = try(aws_route_table.redshift[*].id, [])
  public_route_table_ids   = try(aws_route_table.public[*].id, [])
  private_route_table_ids  = try(aws_route_table.private[*].id, [])
}
...
output "vpc_secondary_cidr_blocks" {
  ...
  value       = compact(try(aws_vpc_ipv4_cidr_block_association.this[*].cidr_block, []))
}
...
output "vpc_block_public_access_exclusions" {
  ...
  value       = try({ for k, v in aws_vpc_block_public_access_exclusion.this : k => v.id }, {})
}
...
output "public_subnets_cidr_blocks" {
  ...
  value       = compact(try(aws_subnet.public[*].cidr_block, []))
}

output "public_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of public subnets in an IPv6 enabled VPC"
  value       = compact(try(aws_subnet.public[*].ipv6_cidr_block, []))
}

output "public_route_table_ids" {
  description = "List of IDs of public route tables"
  value       = try(local.public_route_table_ids, [])
}
...
output "private_subnets_cidr_blocks" {
  ...
  value       = compact(try(aws_subnet.private[*].cidr_block, []))
}

output "private_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of private subnets in an IPv6 enabled VPC"
  value       = compact(try(aws_subnet.private[*].ipv6_cidr_block, []))
}

output "private_route_table_ids" {
  description = "List of IDs of private route tables"
  value       = try(local.private_route_table_ids, [])
}

output "private_nat_gateway_route_ids" {
  description = "List of IDs of the private nat gateway route"
  value       = try(aws_route.private_nat_gateway[*].id, [])
}

output "private_ipv6_egress_route_ids" {
  description = "List of IDs of the ipv6 egress route"
  value       = try(aws_route.private_ipv6_egress[*].id, [])
}
...
output "database_subnet_arns" {
  ...
  value       = try(aws_subnet.database[*].arn, [])
}

output "database_subnets_cidr_blocks" {
  description = "List of cidr_blocks of database subnets"
  value       = compact(try(aws_subnet.database[*].cidr_block, []))
}

output "database_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of database subnets in an IPv6 enabled VPC"
  value       = compact(try(aws_subnet.database[*].ipv6_cidr_block, []))
}
...
output "database_route_table_ids" {
  ...
  value       = try(length(try(aws_route_table.database[*].id, [])) > 0 ? aws_route_table.database[*].id : try(aws_route_table.private[*].id, []), [])
}
...
output "database_nat_gateway_route_ids" {
  ...
  value       = try(aws_route.database_nat_gateway[*].id, [])
}
...
output "database_route_table_association_ids" {
  ...
  value       = try(aws_route_table_association.database[*].id, [])
}
...
output "redshift_subnet_objects" {
  ...
  value       = try(aws_subnet.redshift, [])
}

output "redshift_subnets" {
  description = "List of IDs of redshift subnets"
  value       = try(aws_subnet.redshift[*].id, [])
}

output "redshift_subnet_arns" {
  description = "List of ARNs of redshift subnets"
  value       = try(aws_subnet.redshift[*].arn, [])
}

output "redshift_subnets_cidr_blocks" {
  description = "List of cidr_blocks of redshift subnets"
  value       = compact(try(aws_subnet.redshift[*].cidr_block, []))
}

output "redshift_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of redshift subnets in an IPv6 enabled VPC"
  value       = compact(try(aws_subnet.redshift[*].ipv6_cidr_block, []))
}
...
output "redshift_route_table_ids" {
  ...
  value       = try(length(try(local.redshift_route_table_ids, [])) > 0 ? local.redshift_route_table_ids : (var.enable_public_redshift ? local.public_route_table_ids : local.private_route_table_ids), [])
}

output "redshift_route_table_association_ids" {
  description = "List of IDs of the redshift route table association"
  value       = try(aws_route_table_association.redshift[*].id, [])
}

output "redshift_public_route_table_association_ids" {
  description = "List of IDs of the public redshift route table association"
  value       = try(aws_route_table_association.redshift_public[*].id, [])
}
...
output "elasticache_subnet_objects" {
  ...
  value       = try(aws_subnet.elasticache, [])
}

output "elasticache_subnets" {
  description = "List of IDs of elasticache subnets"
  value       = try(aws_subnet.elasticache[*].id, [])
}

output "elasticache_subnet_arns" {
  description = "List of ARNs of elasticache subnets"
  value       = try(aws_subnet.elasticache[*].arn, [])
}

output "elasticache_subnets_cidr_blocks" {
  description = "List of cidr_blocks of elasticache subnets"
  value       = compact(try(aws_subnet.elasticache[*].cidr_block, []))
}

output "elasticache_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of elasticache subnets in an IPv6 enabled VPC"
  value       = compact(try(aws_subnet.elasticache[*].ipv6_cidr_block, []))
}
...
output "elasticache_route_table_ids" {
  ...
  value       = try(coalescelist(try(aws_route_table.elasticache[*].id, []), try(local.private_route_table_ids, [])), [])
}

output "elasticache_route_table_association_ids" {
  description = "List of IDs of the elasticache route table association"
  value       = try(aws_route_table_association.elasticache[*].id, [])
}
...
output "intra_subnet_objects" {
  ...
  value       = try(aws_subnet.intra, [])
}

output "intra_subnets" {
  description = "List of IDs of intra subnets"
  value       = try(aws_subnet.intra[*].id, [])
}

output "intra_subnet_arns" {
  description = "List of ARNs of intra subnets"
  value       = try(aws_subnet.intra[*].arn, [])
}

output "intra_subnets_cidr_blocks" {
  description = "List of cidr_blocks of intra subnets"
  value       = compact(try(aws_subnet.intra[*].cidr_block, []))
}

output "intra_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of intra subnets in an IPv6 enabled VPC"
  value       = compact(try(aws_subnet.intra[*].ipv6_cidr_block, []))
}

output "intra_route_table_ids" {
  description = "List of IDs of intra route tables"
  value       = try(aws_route_table.intra[*].id, [])
}

output "intra_route_table_association_ids" {
  description = "List of IDs of the intra route table association"
  value       = try(aws_route_table_association.intra[*].id, [])
}
...
output "nat_public_ips" {
  ...
  value       = var.reuse_nat_ips ? var.external_nat_ips : try(aws_eip.nat[*].public_ip, [])
}
...
output "cgw_ids" {
  ...
  value       = [for k, v in try(aws_customer_gateway.this, {}) : v.id]
}

output "cgw_arns" {
  description = "List of ARNs of Customer Gateway"
  value       = [for k, v in try(aws_customer_gateway.this, {}) : v.arn]
}

output "this_customer_gateway" {
  description = "Map of Customer Gateway attributes"
  value       = try(aws_customer_gateway.this, {})
}
...
output "vgw_id" {
  ...
  value       = try(aws_vpn_gateway.this[0].id, try(aws_vpn_gateway_attachment.this[0].vpn_gateway_id, null))
}
...
output "enable_flow_log" {
  description = "Whether VPC Flow Logs are enabled in this module"
...
output "flow_log_destination_arn" {
  description = "The ARN of the destination for VPC Flow Logs (if applicable)"
  value       = var.flow_log_destination_arn
  sensitive   = true
}

output "create_flow_log_cloudwatch_log_group" {
  description = "Whether to create CloudWatch log group for VPC Flow Logs"
  value       = var.create_flow_log_cloudwatch_log_group
}

output "create_flow_log_cloudwatch_iam_role" {
  description = "Whether to create IAM role for VPC Flow Logs"
  value       = var.create_flow_log_cloudwatch_iam_role
}
